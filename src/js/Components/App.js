    ...
    render() {
        return (
            <div className="form form__panel">
                ...
                <DataList />
                <button
                    className={`form form__button form__button--${this.props.selectedColor.colorHex !== "" ? "active" : "disabled"}`}
                    onClick={this.props.selectedColor.colorHex ? this.setColor : void(0)}
                >Accept</button>
            </div>
        )
    }
